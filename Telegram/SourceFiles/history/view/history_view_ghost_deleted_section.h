...
class Element;
class TopBarWidget;
class GhostDeletedMemento;

class GhostDeletedWidget final
...
private:
	...
	void saveState(not_null<GhostDeletedMemento*> memento);
	void restoreState(not_null<GhostDeletedMemento*> memento);
	void showAtPosition(
...
class GhostDeletedMemento final : public Window::SectionMemento {
public:
	explicit GhostDeletedMemento(not_null<History*> history);
