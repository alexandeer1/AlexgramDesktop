...
#ifdef OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"Alexgram.AlexgramDesktop.Store";
#else // OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"Alexgram.AlexgramDesktop";
#endif // OS_WIN_STORE
...
void CleanupShortcut() {
	...
	QString path = systemShortcutPath() + u"Alexgram.lnk"_q;
...
bool checkInstalled(QString path = {}) {
	...
	const auto installed = u"Alexgram/Alexgram.lnk"_q;
	const auto old = u"Telegram Desktop/Telegram.lnk"_q;
