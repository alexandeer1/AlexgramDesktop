...
#elseif (build_win64)
if (build_win64)
    if (EXISTS "${CMAKE_SOURCE_DIR}/Libraries/win64")
        get_filename_component(libs_loc "${CMAKE_SOURCE_DIR}/Libraries/win64" REALPATH)
    else()
        get_filename_component(libs_loc "${CMAKE_SOURCE_DIR}/../Libraries/win64" REALPATH)
    endif()
elseif (build_winarm)
    if (EXISTS "${CMAKE_SOURCE_DIR}/Libraries/winarm")
        get_filename_component(libs_loc "${CMAKE_SOURCE_DIR}/Libraries/winarm" REALPATH)
    elseif (EXISTS "${CMAKE_SOURCE_DIR}/../Libraries/winarm")
        get_filename_component(libs_loc "${CMAKE_SOURCE_DIR}/../Libraries/winarm" REALPATH)
    elseif (EXISTS "${CMAKE_SOURCE_DIR}/Libraries")
        get_filename_component(libs_loc "${CMAKE_SOURCE_DIR}/Libraries" REALPATH)
    else()
        get_filename_component(libs_loc "${CMAKE_SOURCE_DIR}/../Libraries" REALPATH)
    endif()
else()
